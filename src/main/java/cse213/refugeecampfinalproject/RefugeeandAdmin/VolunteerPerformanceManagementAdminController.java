...
import cse213.refugeecampfinalproject.VolunteerModel;
...
{
    @javafx.fxml.FXML
    private TableView<VolunteerPerformanceManagementAdminModel> volunteerWorkTableView;
    @javafx.fxml.FXML
    private TableColumn<VolunteerPerformanceManagementAdminModel, String> tasksTableCol;
    @javafx.fxml.FXML
    private TableColumn<VolunteerModel, String> skillsTableCol;
    @javafx.fxml.FXML
    private TableColumn<VolunteerPerformanceManagementAdminModel, String> serviceAreaTableCol;
    @javafx.fxml.FXML
...
public static ArrayList<VolunteerModel>VolunteerList = new ArrayList<>();
    ...
    public void showPerformanceOnClick(ActionEvent actionEvent) {
        ...
        if(selected.getVolID().equals("V01")) {
            volunteerWorkTableView.getItems().add(new VolunteerPerformanceManagementAdminModel("Education", "Completed 3 sessions", "Teaching"));
        }else if(selected.getVolID().equals("V02")) {
            volunteerWorkTableView.getItems().add(new VolunteerPerformanceManagementAdminModel("Healthcare", "Completed health checkups", "First-aid, CPR"));
        }else if(selected.getVolID().equals("V03")) {
            volunteerWorkTableView.getItems().add(new VolunteerPerformanceManagementAdminModel("Food", "Completed serving 5 meals", "Cooking"));
        }else {
            volunteerWorkTableView.getItems().add(new VolunteerPerformanceManagementAdminModel(selected.getVolServiceArea(), "0 Tasks Completed", selected.getVolSkills()));
        }
    }
